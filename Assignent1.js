Q1 
var c = "Raghavendra";
console.log(c + " intial Value"); //Raghavendra
...
userFriends("taru", "ammu", "deepu", "maha");
let arr = ["Harinath", "Harshitha", "Prabhu", "Krishna", "Sbk"];
userFriends("manasa", ...arr);
